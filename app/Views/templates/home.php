...
<div id="wrapper">
    <?= $this->include("templates/main-header") ?>
    ...
    <main id="main">
            ...
            <div class="slider fade-slider">
                <div>
                    ...
                    <article class="intro-block-slide overlay bg-cover"
                        style="background-image: url(http://placehold.it/1920x823);">
                        <div class="align-wrap container">
                            <div class="align">
                                ...
                                <div class="anim delay1">
                                    <p>We offer the most complete course pakage in the country, for the research, design
                                        and development of Education.</p>
                                </div>
                                <div class="anim delay2">
                                    <div class="btns-wrap">
                                        <a href="courses-list.html" class="btn btn-warning btn-theme text-uppercase">Our
                                            Courses</a>
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="popular-post">
                                ...
                                <h3 class="post-heading"><a href="course/single">French for Beginners to Advanced
                                        Training</a></h3>
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="popular-post">
                                ...
                                <h3 class="post-heading"><a href="course/single">Introduction to Mobile Apps
                                        Development</a></h3>
                                <div class="post-author">
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="popular-post">
                                ...
                                <h3 class="post-heading"><a href="course/single">How to Become a Startup Founder</a>
                                </h3>
                                <div class="post-author">
                                    <div class="alignleft no-shrink rounded-circle">
                                        <a href="instructor-single.html"><img src="http://placehold.it/35x35"
                    ...
                    <div>
                        <div class="col-xs-12">
                            ...
                            <article class="popular-post">
                                ...
                                <h3 class="post-heading"><a href="course/single">Your Complete Guide to Self
                                        Devlopement</a></h3>
                                <div class="post-author">
                                    <div class="alignleft no-shrink rounded-circle">
                                        <a href="instructor-single.html"><img src="http://placehold.it/35x35"
            ...
            <ul class="list-unstyled upcoming-events-list">
                <li>
                    ...
                    <div class="description-wrap">
                        <h3 class="list-heading"><a href="<?= base_url(
                            "event/single"
                        ) ?>">WordPress Theme Development with Bootstrap</a></h3>
                ...
                <li>
                    ...
                    <div class="description-wrap">
                        <h3 class="list-heading"><a href="<?= base_url(
                            "event/single"
                        ) ?>">Build Apps with React Native</a></h3>
                ...
                <li>
                    ...
                    <div class="description-wrap">
                        <h3 class="list-heading"><a href="<?= base_url(
                            "event/single"
                        ) ?>">Free Yoga &amp; Excercise Class at Every Morning</a></h3>
        ...
        <aside class="bg-cover categories-aside text-center"
            style="background-image: url(http://placehold.it/1920x365);">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col">
                    ...
                    <div class="description-wrap">
                        ...
                        <p>German final week mother of god grey viverra no computer unlock impossibru. Pikachu grin
                            venenatis cuteness&hellip;</p>
                        ...
                        <div class="slick-slider slider testimonail-slider">
                            <div>
                                ...
                                <blockquote class="testimonial-quote font-roboto">
                                    <p>“ Trent from punchy rollie grab us a waggin school. Flat out like a bludger where
                                        he hasn't got a damper. As stands out like brass razoo heaps it'll be relo. As
                                        busy as a paddock.”</p>
                                    <cite class="element-block font-lato">
                                        <span class="avatar rounded-circle element-block">
                                            <img class="rounded-circle" src="http://placehold.it/65x65"
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <article class="news-post">
                        <div class="aligncenter">
                            <a href="blog-single.html"><img src="http://placehold.it/360x210"
